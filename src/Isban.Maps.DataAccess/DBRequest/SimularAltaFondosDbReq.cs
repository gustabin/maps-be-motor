namespace Isban.MapsMB.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("SIMULAR_FONDOS", Package = Package.BpServiciosA3, Owner = Owner.BCAINV)]
    internal class SimularAltaFondosDbReq : BcainvRequestBase
    {
        ...
        [DBParameterDefinition(Direction = ParameterDirection.Output, Name = "P_NUM_ORDEN", Type = OracleDbType.Varchar2, ValueConverter = typeof(RequestConvert<string>))]
        public string NumOrden { get; set; }
        [DBParameterDefinition(Direction = ParameterDirection.Output, Name = "P_NUM_CERTIFICADO_FM", Type = OracleDbType.Int64, ValueConverter = typeof(RequestConvert<long?>))]
        ...
        [DBParameterDefinition(Direction = ParameterDirection.Output, Name = "P_DENTRO_DEL_PERFIL", Type = OracleDbType.Varchar2, Size = 10, ValueConverter = typeof(RequestConvert<string>))]
