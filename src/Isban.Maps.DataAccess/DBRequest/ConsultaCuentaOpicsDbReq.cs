...
namespace Isban.MapsMB.DataAccess.DBRequest
{
    ...
    internal class ConsultaCuentaOpicsDbReq : RequestBase
    {
        ...
        [DBParameterDefinition(Direction = ParameterDirection.Input, Size = 1000, Name = "P_OBSERVACION", BindOnNull = true, Type = OracleDbType.Varchar2)]
