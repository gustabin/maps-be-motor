namespace Isban.MapsMB.DataAccess.DBRequest
{
    ...
    [ProcedureRequest("SP_OBTENER_OP_DMEP_COMPRA_FIFO", Package = "PKG_MAPS_TOOLS", Owner = Owner.Maps)]
    internal class ObtenerAdhesionMEPCompraDbReq : RequestBase, IProcedureRequest
    {
